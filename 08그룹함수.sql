...
-------------------------------------------------------------------
--시험대비용
--ROLLUP - GROUP BY 절과 함께 사용되고, 상위그룹에 합계, 토탈 등을 구합니다.
SELECT DEPARTMENT_ID,
        SUM(SALARY),
        AVG(SALARY)
FROM EMPLOYEES
...
--GROUPING 함수 - GROUP BY로 만들어진 경우 0 반환, 롤업 또는 큐브로 만들어진 행인 경우 1 반환
