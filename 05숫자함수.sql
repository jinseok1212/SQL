...
--CEIL 올림
--FLOOP 내림
SELECT ABS(-45), CELL(3.14), FLOOR(3.14) FROM DUAL;
--MOD 나머지
...
SELECT FIRST_NAME, SYSDATE - HIRE_DATE FROM EMPLOYEES; -- 일수 연산
...
SELECT ROUND(SYSDATE, 'MONTH'), TRUNC(SYSDATE, 'MONTH') FROM DUAL; -- 월 기준을 반올림, 절삭
