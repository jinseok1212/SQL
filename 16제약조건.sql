...
--1ST (열레벨 제약조건)
CREATE TABLE DEPTS(
    DEPT_NO NUMBER(2)       CONSTRAINT DEPTS_DEPT_NO_PK PRIMARY KEY, --CONSTRAINT (이름) 생략가능 하지만 이름 자동 생성되어 무슨값인지 알지 못함
...
INSERT INTO DEPTS(DEPT_NO, DEPT_NAME, DEPT_PHONE, DEPT_GENDER, LOCA_ID)
VALUES(1, 'HONG', '010..', 'ㅌ', 1700); --CHECK 제약 위배
...
CREATE TABLE DEPTS(
    ...
    DEPT_GENDER CHAR(1),
    LOCA_ID NUMBER(4),
    CONSTRAINT DEPT_DEPT_NO_PK PRIMARY KEY(DEPT_NO, /*DEPT_NAME*/), --컬럼명 (슈퍼키는 테이블레벨로 지정가능함)
...
CREATE TABLE A (
    ...
    CONSTRAINT MEM_GENDER_CK CHECK (GENDER IN ('M', 'K')),
    CONSTRAINT MEM_LOCA_LOC_LOCID_FK FOREIGN KEY (LOCA) REFERENCES LOCATIONS(LOCATION_ID)
);
INSERT INTO A VALUES('AAA', 1, '2018-07-01', 'M', 1800);
INSERT INTO A VALUES('BBB', 2, '2018-07-02', 'M', 1900);
INSERT INTO A VALUES('CCC', 3, '2018-07-03', 'M', 2000);
INSERT INTO A VALUES('DDD', 4, SYSDATE, 'M', 2000);
SELECT * FROM A;
--문제2.
--
...
CREATE TABLE LIBRARY (
    ...
    BOOK_NUM VARCHAR2(30) UNIQUE,
    RENT_DATE DATE NOT NULL,
    RETURN_DATE DATE NOT NULL,
    RETURN_YN CHAR(1) CHECK (RETURN_YN IN ('Y','N'))
);
INSERT INTO LIBRARY VALUES(1, 'BOOKNUM23', '2018-12-21', SYSDATE, 'Y');
SELECT * FROM LIBRARY;